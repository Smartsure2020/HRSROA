    ...
    <div>
      ...
      <FormCard>
        ...
        <LegalBlock title="Broker (Intermediary) Fee Consent" className="mt-4">
          ...
          <p className="mt-1">A broker fee is an amount charged by Holistic Risk Services (Pty) Ltd for additional services rendered to you, which include but are not limited to: risk profiling, claims intervention, onsite visits, assistance with rejected claims, car hire management, accident support, and ongoing portfolio management. The broker fee amount is disclosed to you in Step 3 of this advice record.</p>
