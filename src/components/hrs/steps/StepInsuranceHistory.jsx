...
export default function StepInsuranceHistory({ data, onChange, onNext, onPrev, nextLabel }) {
  ...
  return (
    <div>
      <FormCard>
        ...
        <p className="text-hrs-muted text-[0.82rem] mb-7">Summary of the client's previous short-term insurance experience</p>
        ...
        <SectionTitle size="sm">Client Needs & Objectives</SectionTitle>
        <div className="mt-3">
          <FormField label="Summary of Client's Specific Needs">
